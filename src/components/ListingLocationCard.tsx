  ...
  return (
    <>
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <button
          type="button"
          className="group mt-4 block w-full overflow-hidden rounded-2xl border border-slate-200 bg-slate-50"
          onClick={() => setOpen(true)}
          aria-label="Deschide harta"
        >
          <div className="relative h-48 w-full">
            <ListingLocationMap location={location} />
            <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-slate-950/30 via-slate-950/10 to-transparent p-3 text-left">
              <div className="inline-flex items-center rounded-full bg-white/90 px-3 py-1 text-xs font-semibold text-slate-900 shadow-sm">
